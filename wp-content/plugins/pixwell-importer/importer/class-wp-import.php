...
<?php
	...
	function process_menu_item( $item ) {
		...
		if ( $id && ! is_wp_error( $id ) ) {
			if ( isset( $_pixwell_mega_cat ) ) {
				update_post_meta( $id, '_pixwell_mega_cat', $_pixwell_mega_cat );
			}
			if ( isset( $_pixwell_mega_cat_ajax ) ) {
				update_post_meta( $id, '_pixwell_mega_cat_ajax', $_pixwell_mega_cat_ajax );
			}
			if ( isset( $_pixwell_mega_col ) ) {
				update_post_meta( $id, '_pixwell_mega_col', $_pixwell_mega_col );
			}
			if ( isset( $_pixwell_mega_col_bg ) ) {
				update_post_meta( $id, '_pixwell_mega_col_bg', $_pixwell_mega_col_bg );
			}
			if ( isset( $_pixwell_sub_image ) ) {
				update_post_meta( $id, '_pixwell_sub_image', $_pixwell_sub_image );
			}
