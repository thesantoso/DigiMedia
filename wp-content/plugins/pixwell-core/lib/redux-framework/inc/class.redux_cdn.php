...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'Redux_CDN' ) ) {
        class Redux_CDN {
            ...
            private static function _register( $handle, $src_cdn, $deps, $ver, $footer_or_media, $is_script = 1 ) {
                if ( $is_script ) {
            ...
            private static function _cdn( $register, $handle, $src_cdn, $deps, $ver, $footer_or_media, $is_script = 1 ) {
