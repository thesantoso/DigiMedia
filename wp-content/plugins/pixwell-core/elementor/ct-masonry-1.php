...
class Ct_Masonry_1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Pixwell - Content Masonry 1', 'pixwell-core' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'top_classic',
			array(
				'label'       => esc_html__( '1st Classic', 'pixwell-core' ),
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Enable or disable 1st classic (centered) layout for this this block.', 'pixwell-core' ),
				'options'     => array(
	...
	protected function render() {
		if ( function_exists( 'pixwell_rbc_ct_masonry_1' ) ) {
			...
			echo \pixwell_rbc_ct_masonry_1( $settings );
		}
	}
}
