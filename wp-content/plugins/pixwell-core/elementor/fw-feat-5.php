...
class Fw_Feat_5 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Pixwell - Slider (Wrapper)', 'pixwell-core' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'image_opacity',
            array(
                'label' => esc_html__( 'Opacity for dark overlay', 'elementor' ),
                ...
                'selectors' => array(
                    '.is-fmask {{WRAPPER}} .p-overlay.f-gradient .rb-iwrap:after,{{WRAPPER}} .p-overlay-4 .p-feat:after' => 'opacity: {{SIZE}};',
                ),
            )
        );
	...
	protected function render() {
		if ( function_exists( 'pixwell_rbc_fw_feat_5' ) ) {
			...
			echo \pixwell_rbc_fw_feat_5( $settings );
		}
	}
}
