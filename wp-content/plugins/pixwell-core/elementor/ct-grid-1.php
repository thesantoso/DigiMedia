...
class Ct_Grid_1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Pixwell - Content Grid 1 (2 Cols)', 'pixwell-core' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'post_shadow',
            array(
                'label'       => esc_html__( 'Box shadow', 'pixwell-core' ),
                'type'        => Controls_Manager::SELECT,
                'description' => esc_html__( 'Enable or disable the box shadow.', 'pixwell-core' ),
                'options'     => \PixwellElementorControl\Options::shadow_dropdown(),
                'default'     => '0',
            )
        );
	...
	protected function render() {
		if ( function_exists( 'pixwell_rbc_ct_grid_1' ) ) {
			...
			echo \pixwell_rbc_ct_grid_1( $settings );
		}
	}
}
