...
class Fw_Mix_1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Pixwell - Mix 1 (FullWidth/Content)', 'pixwell-core' );
	}
	...
	protected function render() {
		if ( function_exists( 'pixwell_rbc_fw_mix_1' ) ) {
			...
			$settings['classes'] = 'fw-block block-mix fw-mix-1';
			echo \pixwell_rbc_fw_mix_1( $settings );
		}
	}
}
