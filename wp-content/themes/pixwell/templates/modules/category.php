	...
	function pixwell_module_category( $cat_id, $attachment_size = '', $title_size = 'h4' ) {
		...
		<div class="<?php echo esc_attr( $class_name ) ?>">
			...
			<div class="cat-list-feat">
                <img src="<?php echo esc_html( $cat_featured ); ?>" alt="<?php echo esc_html( $cat_name ); ?>" loading="lazy" width="<?php if ( ! empty( $image_size[0] ) ) { echo esc_attr( $image_size[0] ); } ?>" height="<?php if ( ! empty( $image_size[1] ) ) { echo esc_attr( $image_size[1] ); } ?>">
			</div>
