 ...
 * content mix 2
 */
if ( ! function_exists( 'pixwell_rbc_ct_mix_2' ) ) {
	function pixwell_rbc_ct_mix_2( $attrs ) {
		...
		$settings['classes'] = 'ct-block block-mix ct-mix-2 none-margin rb-col-m12 rb-col-d6';
		...
		if ( $query_data->have_posts() ) :
			...
			pixwell_rbc_ct_mix_2_listing( $settings, $query_data );
...
/**
 * content mix 2 listing
 */
if ( ! function_exists( 'pixwell_rbc_ct_mix_2_listing' ) ) :
	function pixwell_rbc_ct_mix_2_listing( $settings, $query_data ) {
 ...
 */
if ( ! function_exists( 'pixwell_register_ct_mix_2' ) ) {
	function pixwell_register_ct_mix_2( $blocks ) {
		...
		$blocks[] = array(
			...
			'section'     => 'content',
			'img'         => get_theme_file_uri( 'assets/images/ct-mix-2.png' ),
			'inputs'      => array(
				array(
					'type'        => 'category',
					'tab'         => 'filter',
...
add_filter( 'rbc_add_block', 'pixwell_register_ct_mix_2', 131 );
