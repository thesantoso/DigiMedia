 ...
 * fullwidth feat 1
 */
if ( ! function_exists( 'pixwell_rbc_fw_feat_1' ) ) {
	function pixwell_rbc_fw_feat_1( $attrs ) {
 ...
 */
if ( ! function_exists( 'pixwell_register_fw_feat_1' ) ) {
	function pixwell_register_fw_feat_1( $blocks ) {
		...
		$blocks[] = array(
			...
			'section'     => 'fullwidth',
			'img'         => get_theme_file_uri( 'assets/images/fw-feat-1.png' ),
			'inputs'      => array(
				array(
					'type'        => 'category',
					'tab'         => 'filter',
...
add_filter( 'rbc_add_block', 'pixwell_register_fw_feat_1', 10 );