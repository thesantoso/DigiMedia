 ...
 * fullwidth list 1
 */
if ( ! function_exists( 'pixwell_rbc_fw_list_1' ) ) {
	function pixwell_rbc_fw_list_1( $attrs ) {
		...
		$settings['classes'] = 'fw-block fw-list-1';
 ...
 * fw list 1 listing
 */
if ( ! function_exists( 'pixwell_rbc_fw_list_1_listing' ) ) :
	function pixwell_rbc_fw_list_1_listing( $settings , $query_data ) {
 ...
 */
if ( ! function_exists( 'pixwell_register_fw_list_1' ) ) {
	function pixwell_register_fw_list_1( $blocks ) {
		...
		$blocks[] = array(
			'name'        => 'fw_list_1',
			'title'       => esc_html__( 'List 1', 'pixwell' ),
			'description' => esc_html__( 'Display your posts as a list (1 column) in the fullwidth section.', 'pixwell' ),
			'section'     => 'fullwidth',
...
add_filter( 'rbc_add_block', 'pixwell_register_fw_list_1', 30 );
