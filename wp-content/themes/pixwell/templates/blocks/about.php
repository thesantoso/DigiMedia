		...
		<div class="about-me-wrap">
			<?php if ( ! empty( $settings['about_image'] ) ) :
				...
				<div class="about-image">
                    <img loading="lazy" src="<?php echo esc_url( $settings['about_image'] ); ?>" alt="<?php esc_html__( 'about me', 'pixwell' ); ?>" width="<?php if ( ! empty( $size[0] ) ) { echo esc_attr( $size[0] ); } ?>" height="<?php if ( ! empty( $size[1] ) ) { echo esc_attr( $size[1] ); } ?>">
				</div>
			<?php endif; ?>
