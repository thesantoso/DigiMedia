 ...
 * content list 2
 */
if ( ! function_exists( 'pixwell_rbc_ct_list' ) ) {
	function pixwell_rbc_ct_list( $attrs ) {
		...
		$settings['classes'] = 'ct-block ct-list';
 ...
 */
if ( ! function_exists( 'pixwell_rbc_ct_list_listing' ) ) :
	function pixwell_rbc_ct_list_listing( $settings, $query_data ) {
 ...
 */
if ( ! function_exists( 'pixwell_register_ct_list' ) ) {
	function pixwell_register_ct_list( $blocks ) {
		...
		$blocks[] = array(
			'name'        => 'ct_list',
			'title'       => esc_html__( 'List', 'pixwell' ),
			'description' => esc_html__( 'Display your posts as a list (1 column) in the content section.', 'pixwell' ),
			'section'     => 'content',
...
add_filter( 'rbc_add_block', 'pixwell_register_ct_list', 120 );
