					...
					<div class="rb-about-inner">
						<div class="about-holder">
							...
							if ( ! empty( $settings['description'] ) ) : ?>
								<p class="about-bio"><?php echo wp_kses_post( $settings['description'] ) ?></p>
							<?php endif;
							if ( ! empty( $settings['signature'] ) ) :
                                $signature_size = pixwell_getimagesize( $settings['signature'] );
                                ?>
								<div class="about-signature">
									<img src="<?php echo esc_url( $settings['signature'] ); ?>" alt="<?php echo esc_attr( $settings['intro'] ); ?>" width="<?php if ( ! empty( $signature_size[0] ) ) { echo esc_attr( $signature_size[0] ); } ?>" height="<?php if ( ! empty( $signature_size[1] ) ) { echo esc_attr( $signature_size[1] ); } ?>">
								</div>
							<?php endif;
