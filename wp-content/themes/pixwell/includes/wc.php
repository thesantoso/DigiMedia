...
add_action( 'woocommerce_after_quantity_input_field', 'pixwell_wc_quantity_button' );
add_filter('yith_wcwl_table_before_product_name', 'pixwell_wishlist_before_title');
add_filter('yith_wcwl_table_after_product_name', 'pixwell_wishlist_after_title');
...
if ( ! function_exists( 'pixwell_wishlist_before_title' ) ) {
	function pixwell_wishlist_before_title() {
		echo '<span class="h5">';
	}
}
