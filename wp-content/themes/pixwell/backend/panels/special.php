		...
		return array(
			...
			'fields' => array(
				...
				array(
					...
					'subtitle' => esc_html__( 'Input the delay time (ms) to show the popup after the site loaded.', 'pixwell' ),
					'default'  => '1000'
				),
				array(
		...
		return array(
			...
			'fields' => array(
				...
				array(
					'id'       => 'unique_reaction',
					'type'     => 'switch',
					'title'    => esc_html__( 'Unique Reaction', 'pixwell' ),
					'subtitle' => esc_html__( 'User can only submit one reaction at a time. User reaction data will be refreshed if turn this option on/off.', 'pixwell' ),
					'switch'   => true,
					'default'  => 0
				),
				array(
				...
				array(
					...
					'type'   => 'section',
					'class'  => 'ruby-section-start',
					'title'  => esc_html__( 'Reaction Items', 'pixwell' ),
					'indent' => true
				),
				array(
					'id'       => 'reaction_love',
