...
if ( ! function_exists( 'pixwell_register_options_styling_grid_3' ) ) {
	function pixwell_register_options_styling_grid_3() {
		return array(
			...
			'icon'       => 'el el-th-large',
			'desc'       => html_entity_decode( esc_html__( 'Setup styles for layout grid 3. This is a big grid post layout. Show in block below: <em>Grid 3 (FullWidth)</em><em>Beauty Featured Grid</em><em>Blog, Archive FullWidth Grid 3 Listing</em>', 'pixwell' ) ),
			'subsection' => true,
			'fields'     => array(
				array(
...
if ( ! function_exists( 'pixwell_register_options_styling_list_2' ) ) {
	function pixwell_register_options_styling_list_2() {
		return array(
			...
			'icon'       => 'el el-th-list',
			'desc'       => html_entity_decode( esc_html__( 'Setup styles for the layout list 2. This is a small list post layout. Show in blocks below: <em>List 2 (FullWidth)</em><em>Beauty Featured Grid</em><em>Blog, Archive Listing: FullWidth List 2</em>', 'pixwell' ) ),
			'subsection' => true,
			'fields'     => array(
				array(
...
if ( ! function_exists( 'pixwell_register_options_styling_list_7' ) ) {
	function pixwell_register_options_styling_list_7() {
		return array(
			...
			'icon'       => 'el el-th-large',
			'subsection' => true,
			'desc'       => html_entity_decode( esc_html__( 'Setup styles for the layout list 7. This is the big list layout. Show in blocks below: <em>Decor Slider (Stretched)</em>', 'pixwell' ) ),
			'fields'     => array(
				array(
...
if ( ! function_exists( 'pixwell_register_options_styling_list_8' ) ) {
	function pixwell_register_options_styling_list_8() {
		return array(
			...
			'icon'       => 'el el-th-large',
			'subsection' => true,
			'desc'       => html_entity_decode( esc_html__( 'Setup styles for the layout list 8. This is the big list layout. Show in blocks below: <em>Marketing Grid</em>', 'pixwell' ) ),
			'fields'     => array(
				array(
...
if ( ! function_exists( 'pixwell_register_options_styling_list_9' ) ) {
	function pixwell_register_options_styling_list_9() {
		return array(
			...
			'icon'       => 'el el-th-list',
			'desc'       => html_entity_decode( esc_html__( 'Setup styles for the layout list podcast. This is a small list post layout. Show in blocks below: <em>List Podcast (FullWidth)</em><em>Beauty Featured Grid</em><em>Blog, Archive Listing: FullWidth List 2</em>', 'pixwell' ) ),
			'subsection' => true,
			'fields'     => array(
				array(
