		...
		return array(
			...
			'fields' => array(
				...
				array(
					...
					'subtitle' => esc_html__( 'input your social profile URL, Leave blank if you want to disable it.', 'pixwell' ),
					'default'  => ''
				),
				array(
					'id'       => 'social_twitter',
				...
				array(
					...
					'subtitle' => esc_html__( 'input your social profile URL.', 'pixwell' )
				),
				array(
