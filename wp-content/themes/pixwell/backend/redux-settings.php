...
include_once get_theme_file_path( 'backend/panels/dark-mode.php' );
...
include_once get_theme_file_path( 'backend/panels/performance.php' );
...
include_once get_theme_file_path( 'backend/panels/table-contents.php' );

$pixwell_display  = esc_html__( 'Pixwell Panel', 'pixwell' ) . '<span class="p-version">' . wp_get_theme()->get( 'Version' ) . '</span>';
$pixwell_info     = '<span class="pdocs-info"><i class="el el-folder-open"></i><a href="https://help.themeruby.com/pixwell" target="_blank">' . esc_html__( 'Online Documentation', 'pixwell' ) . '</a></span>';
$pixwell_opt_name = 'pixwell_theme_options';

$pixwell_args = array(
	'opt_name'             => $pixwell_opt_name,
	'display_name'         => $pixwell_display,
	'display_version'      => $pixwell_info,
	'menu_type'            => 'menu',
	'allow_sub_menu'       => true,
...
Redux::setSection( $pixwell_opt_name, pixwell_register_options_dark_mode() );
...
Redux::setSection( $pixwell_opt_name, pixwell_register_options_feat_img() );
...
Redux::setSection( $pixwell_opt_name, pixwell_register_options_styling_grid_7() );
...
Redux::setSection( $pixwell_opt_name, pixwell_register_options_styling_list_7() );
Redux::setSection( $pixwell_opt_name, pixwell_register_options_styling_list_8() );
Redux::setSection( $pixwell_opt_name, pixwell_register_options_styling_list_9() );
...
Redux::setSection( $pixwell_opt_name, pixwell_register_options_single_review() );

Redux::setSection( $pixwell_opt_name, pixwell_register_options_page() );
...
Redux::setSection( $pixwell_opt_name, pixwell_register_options_performance() );
...
Redux::setSection( $pixwell_opt_name, pixwell_register_options_table_contents() );
...
Redux::setSection( $pixwell_opt_name, pixwell_register_options_backup() );
